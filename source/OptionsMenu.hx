			...
			if (controls.ACCEPT)
			{
				...
				switch(curSelected)
				{
					...
					case 7:
						...
						var ctrl:Alphabet = new Alphabet(0, (70 * curSelected) + 30, (FlxG.save.data.modcharts ? "Modcharts On" : "Modcharts Off"), true, false);
						ctrl.isMenuItem = true;
